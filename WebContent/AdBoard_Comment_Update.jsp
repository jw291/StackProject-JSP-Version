...
if(w == null || w.equals("w")){
	msg = "작성";
	AdCommentDataBean pe = new AdCommentDataBean(0,b_no,co_no,co_content,co_id);
	...
	msg = "수정";
	AdCommentDataBean pe = new AdCommentDataBean(co_no,b_no,co_no,co_content,co_id);
	Connection conn = null;
	try{
		conn = MySQLConnection.getConnection();//getConnection이 exception
		AdCommentDataDAO dao = AdCommentDataDAO.getInstance();
...
out.println("<script>location.replace('./AdBoardViewAction.do?number=" + b_no + "')</script>");
