			...
			<!--&bno가 존재한다면 b_id를 뽑아온다. 존재하지 않으면 인풋으로 입력할 수 있게 한다 하지만 수정할때 아이디를 바꿀 필요는 없으니 사실상 무쓸모-->
				<table id="boardWrite">
					<tbody>
						...
						<tr>
							<th scope="row"><label for="bTitle">모임명</label></th>
				...
				<div class="btnSet">
					<a href="./AdBoardViewAction.do" class="btnList btn">목록</a>
					<a href="./Thread_Register.jsp?threadname=${threadname}" calss="btnList btn">가입신청</a>
				</div>
			<hr style="color:#999999; border-style:dotted">

	<!--댓글 php를 include시켜준다.-->
	<div id="boardComment">
		<jsp:include page="./AdBoard_Comment.jsp"/>
