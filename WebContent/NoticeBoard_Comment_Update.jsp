...
if(w == null || w.equals("w")){
	msg = "작성";
	NoticeCommentDataBean pe = new NoticeCommentDataBean(0,b_no,co_no,co_content,co_id);
	...
	msg = "수정";
	NoticeCommentDataBean pe = new NoticeCommentDataBean(co_no,b_no,co_no,co_content,co_id);
	Connection conn = null;
	try{
		conn = MySQLConnection.getConnection();//getConnection이 exception
		NoticeCommentDataDAO dao = NoticeCommentDataDAO.getInstance();
...
out.println("<script>location.replace('./NoticeBoard_View.jsp?number=" + b_no + "')</script>");
