								...
								<article class="boardArticle" style="margin-left:0;">
										<div class="card mb-3" style="width:1200px;">
											<div class="card-header">
												<i class="fa fa-table"></i> 자유 게시판</div>
										<div id="boardList">
											<div class="card-body">
...
<c:forEach var="pe" items="${list}">
					<tr>
						...
						<td align="center"><a href="FreeBoardViewAction.do?number=${pe.getBnum()}" style="cursor:pointer;">${pe.getBtitle()}</a></td>
						...
						<td align="center">${pe.getBhit()}</td>
									...
									<%}else{%>
									<a class="btnWrite btn" href="./FreeBoard_Write.jsp">글쓰기</a>
									<%} %>
									</div>
											</div>
...
function PageMove(page){
    location.href = "FreeBoardPaginationAction.do?page="+page;
  }
