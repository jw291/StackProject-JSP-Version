...
<jsp:include page="header.jsp" /> <%-- 정적 include --%>
    ...
    <div class="container-fluid">
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="breadcrumb-item active">AdBoard</li>
		      </ol>
													...
													<table class="table table-bordered"  style="width:100%" cellspacing="0">
														<thead>
															<tr>
																...
																<th style="text-align: center;">모임명</th>
...
<c:forEach var="pe" items="${list}">
					<tr>
						...
						<td align="center"><a href="AdBoardViewAction.do?number=${pe.getBnum()}" style="cursor:pointer;">${pe.getBtitle()}</a></td>
						<td align="center">${pe.getThreadname()}</td>
						...
						<td align="center">${pe.getBhit()}</td>
									...
									<%}else{%>
									<a class="btnWrite btn" href="./AdBoard_Write.jsp">글쓰기</a>
									<%} %>
									</div>
											</div>
...
function PageMove(page){
    location.href = "AdBoardPaginationAction.do?page="+page;
  }
