...
if(w == null || w.equals("w")){
	msg = "작성";
	FreeCommentDataBean pe = new FreeCommentDataBean(0,b_no,co_no,co_content,co_id);
	...
	msg = "수정";
	FreeCommentDataBean pe = new FreeCommentDataBean(co_no,b_no,co_no,co_content,co_id);
	Connection conn = null;
	try{
		conn = MySQLConnection.getConnection();//getConnection이 exception
		FreeCommentDataDAO dao = FreeCommentDataDAO.getInstance();
...
out.println("<script>location.replace('./FreeBoardViewAction.do?number=" + b_no + "')</script>");
