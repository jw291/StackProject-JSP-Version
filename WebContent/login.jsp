...
<body class="bg-dark">
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <form class="form-signin" method=POST action=loginUpdate.jsp>
          ...
          <div class="form-group">
            ...
            <input class="form-control" name="user_pw" type="password" placeholder="Password">
          </div>
          <div class="form-group">
	  ...
	  <a class="d-block small" href="./home.jsp">home</a>
        </div>
      </div>
    </div>
  </div>
