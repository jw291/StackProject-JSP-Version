...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">게시판 글 수정</li>
      </ol>
	<!-- free board-->
	<article class="boardArticle">
		<h3>게시판 글 수정</h3>
		<div id="boardWrite">
			<form action=./ThBoardEditAction.do method=POST>
				...
				<table id="boardWrite">
					<tbody>
						...
						<tr>
							...
							<td class="title"><input type="text" name="bTitle" id="bTitle" value=${title }></td>
						</tr>
						<tr>
...
function submitContents(elClickedObj) {
  ...
  elClickedObj.form.submit();
				...
				<div class="btnSet">
					...
					<a href="./ThBoardPaginationAction.do" class="btnList btn">목록</a>
				</div>
			</form>
		</div>
	</article>
